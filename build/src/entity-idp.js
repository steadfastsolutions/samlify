...
var metaWord = urn_1.wording.metadata;
/**
...
var IdentityProvider = /** @class */ (function (_super) {
    ...
    function IdentityProvider(idpSetting) {
        ...
        if (idpSetting.loginResponseTemplate) {
            if (lodash_1.isString(idpSetting.loginResponseTemplate.context) && Array.isArray(idpSetting.loginResponseTemplate.attributes)) {
                var replacement = {
                    AttributeStatement: libsaml_1.default.attributeStatementBuilder(idpSetting.loginResponseTemplate.attributes),
                };
                entitySetting.loginResponseTemplate = __assign({}, entitySetting.loginResponseTemplate, { context: libsaml_1.default.replaceTagsByValue(entitySetting.loginResponseTemplate.context, replacement) });
            }
            else {
    ...
    IdentityProvider.prototype.createLoginResponse = function (sp, requestInfo, binding, user, customTagReplacement, encryptThenSign) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        protocol = urn_1.namespace.binding[binding] || urn_1.namespace.binding.redirect;
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, __assign({}, context, { entityEndpoint: sp.entityMeta.getAssertionConsumerService(binding), type: 'SAMLResponse' })];
                    case 2: 
