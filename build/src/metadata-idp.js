...
var IdpMetadata = /** @class */ (function (_super) {
    ...
    function IdpMetadata(meta) {
        var _this = this;
        var isFile = lodash_1.isString(meta) || meta instanceof Buffer;
        if (!isFile) {
    ...
    */
    IdpMetadata.prototype.getSingleSignOnService = function (binding) {
        if (lodash_1.isString(binding)) {
            ...
            var service = this.meta.singlesignonservice.find(function (obj) { return obj[bindName_1]; });
            if (service) {
                return service[bindName_1];
            }
        }
