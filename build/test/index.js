...
// Define of metadata
var _idpKeyFolder = './test/key/idp/';
var _idpPrivPem = String(fs_1.readFileSync(_idpKeyFolder + 'privkey.pem'));
var _idpPrivKey = _idpKeyFolder + 'nocrypt.pem';
var _idpPrivKeyPass = 'q9ALNhGT5EhfcRmp8Pg7e9zTQeP2x1bW';
...
(function () {
    ...
    var _originResponse = String(fs_1.readFileSync('./test/misc/response.xml'));
    var _decodedResponse = String(fs_1.readFileSync('./test/misc/response_signed.xml'));
    var _decodedResponseDoc = new xmldom_1.DOMParser().parseFromString(_decodedResponse);
    var _decodedResponseSignature = xml_crypto_1.xpath(_decodedResponseDoc, "/*/*[local-name(.)='Signature']")[0];
    var _decodedRequestSHA1 = String(fs_1.readFileSync('./test/misc/signed_request_sha1.xml'));
    ...
    var _decodedRequestDocSHA256 = new xmldom_1.DOMParser().parseFromString(_decodedRequestSHA256);
    var _decodedRequestSignatureSHA256 = xml_crypto_1.xpath(_decodedRequestDocSHA256, "/*/*[local-name(.)='Signature']")[0];
    ...
    var _decodedRequestDocSHA512 = new xmldom_1.DOMParser().parseFromString(_decodedRequestSHA512);
    var _decodedRequestSignatureSHA512 = xml_crypto_1.xpath(_decodedRequestDocSHA512, "/*/*[local-name(.)='Signature']")[0];
    ...
    */
    ...
    ava_1.default('verify a XML signature signed by RSA-SHA1 with .cer keyFile', function (t) {
        ...
        var decodedResponseDoc = new xmldom_1.DOMParser().parseFromString(xml);
        var signature = xml_crypto_1.xpath(decodedResponseDoc, "/*/*[local-name(.)='Signature']")[0];
    ...
    ava_1.default('get innerText returns a value', function (t) {
        t.is(libsaml.extractor(_decodedResponse, ['NameID'])['nameid'], '_ce3d2948b4cf20146dee0a0b3dd6f69b6cf86f62d7');
    });
    ava_1.default('get innerText returns undefined', function (t) {
        t.is(libsaml.extractor(_decodedResponse, ['notexist'])['notexist'] === undefined, true);
    });
    ava_1.default('get innerText returns an array of values', function (t) {
    ...
    ava_1.default('get innerText returns a value with custom key', function (t) {
        t.is(libsaml.extractor(_decodedResponse, [{ localName: 'NameID', customKey: 'nid' }])['nid'], '_ce3d2948b4cf20146dee0a0b3dd6f69b6cf86f62d7');
    });
    ava_1.default('get attributes returns an object', function (t) {
    ...
    ava_1.default('get attributes returns an array of objects', function (t) {
        t.is(JSON.stringify(libsaml.extractor(_decodedResponse, [{
                localName: 'Attribute',
    ...
    ava_1.default('get attributes returns an undefined for non-exist attribute', function (t) {
        t.is(libsaml.extractor(_decodedResponse, [{
                localName: 'Conditions',
                attributes: ['notexist'],
            }])['conditions'].notexist === undefined, true);
    });
    ava_1.default('get attributes returns an undefined with non-exist localName', function (t) {
        t.is(libsaml.extractor(_decodedResponse, [{
                localName: 'Condition',
                attributes: ['notexist'],
            }])['condition'] === undefined, true);
    });
    ava_1.default('get attributes returns a value with custom key', function (t) {
        t.is(libsaml.extractor(_decodedResponse, [{
                localName: 'Conditions',
                attributes: ['notexist'],
                customKey: 'cd',
    ...
    ava_1.default('get entire text returns a xml string', function (t) {
        t.is(JSON.stringify(libsaml.extractor(_decodedResponse, [{
                localName: 'Signature',
    ...
    ava_1.default('get entire text returns undefined', function (t) {
        t.is(libsaml.extractor(_decodedResponse, [{ localName: 'Not Exist', extractEntireBody: true }]).signature === undefined, true);
    });
    ava_1.default('get entire text returns a value with custom key', function (t) {
        t.is(JSON.stringify(libsaml.extractor(_decodedResponse, [{
                localName: 'Signature',
                extractEntireBody: true,
                customKey: 'cd',
    ...
    ava_1.default('get attirbute-innerText (kv) pair, single value returns string', function (t) {
    ...
    ava_1.default('get attirbute-innerText (kv) pair, multi values returns array composed of multi strings', function (t) {
        t.is(JSON.stringify(libsaml.extractor(_decodedResponse, [{
                localName: {
                    tag: 'Attribute',
                    key: 'Name',
    ...
    ava_1.default('get attirbute-innerText (kv) pair, non-exist key returns undefined', function (t) {
        t.is(JSON.stringify(libsaml.extractor(SPMetadata.xmlString, [{
                localName: {
                    tag: 'KeyDescriptor',
                    key: 'used',
    ...
    ava_1.default('get attirbute-innerText (kv) pair, non-exist value returns undefined', function (t) {
        t.is(JSON.stringify(libsaml.extractor(SPMetadata.xmlString, [{
                localName: {
                    tag: 'KeyDescriptor',
                    key: 'use',
    ...
    ava_1.default('get attirbute-innerText (kv) pair, non-exist tag should return undefined', function (t) {
        t.is(JSON.stringify(libsaml.extractor(SPMetadata.xmlString, [{
                localName: {
                    tag: 'KeyDescription',
                    key: 'encrypt',
    ...
    ava_1.default('get attirbute-innerText (kv) pair, returns value with custom key', function (t) {
        t.is(JSON.stringify(libsaml.extractor(_decodedResponse, [{
                localName: {
                    tag: 'Attribute',
                    key: 'Name',
    ...
    ava_1.default('get attirbutev1-attributev2 (kv) pair, single value returns array consisting one object', function (t) {
        t.is(JSON.stringify(libsaml.extractor(SPMetadata.xmlString, [{
                localName: { tag: 'AssertionConsumerService', key: 'isDefault' },
                attributeTag: 'index',
            }])['assertionconsumerservice']), '[{"true":"0"}]');
    });
    ava_1.default('get attirbutev1-attributev2 (kv) pair, multi values returns array composed of multi objects', function (t) {
        t.is(JSON.stringify(libsaml.extractor(SPMetadata.xmlString, [{
                localName: {
    ...
    ava_1.default('get attirbutev1-attributev2 (kv) pair, non-exist tag returns undefined', function (t) {
        t.is(JSON.stringify(libsaml.extractor(SPMetadata.xmlString, [{
                localName: {
    ...
    ava_1.default('get attirbutev1-attributev2 (kv) pair, non-exist key returns undefined', function (t) {
        t.is(JSON.stringify(libsaml.extractor(SPMetadata.xmlString, [{
                localName: {
                    tag: 'SingleLogoutService',
                    key: 'Winding',
    ...
    ava_1.default('get attirbutev1-attributev2 (kv) pair, non-exist attribute tag returns undefined', function (t) {
        t.is(JSON.stringify(libsaml.extractor(SPMetadata.xmlString, [{
                localName: {
                    tag: 'SingleLogoutService',
                    key: 'Binding',
    ...
    ava_1.default('get attirbutev1-attributev2 (kv) pair, returns value with custom key', function (t) {
        t.is(JSON.stringify(libsaml.extractor(SPMetadata.xmlString, [{
                localName: {
                    tag: 'SingleLogoutService',
                    key: 'Binding',
...
ava_1.default('verify time', function (t) {
    var timeAfter5Mins = new Date();
    var timeBefore5Mins = new Date();
...
ava_1.default('metadata with multiple entity descriptors is invalid', function (t) {
    try {
        identityProvider(__assign({}, defaultIdpConfig, { metadata: './test/misc/multiple_entitydescriptor' }));
        t.fail();
    }
    catch (_a) {
...
ava_1.default('undefined x509 key in metadata should throw error', function (t) {
    try {
