...
(function () {
    ...
    var acs = libsaml.extractor(spxml, [{ localName: 'AssertionConsumerService', attributes: ['index'] }])['assertionconsumerservice'];
    var spslo = libsaml.extractor(spxml, [{ localName: 'SingleLogoutService', attributes: ['index'] }])['singlelogoutservice'];
    var sso = libsaml.extractor(idpxml, [{ localName: 'SingleSignOnService', attributes: ['index'] }])['singlesignonservice'];
    var idpslo = libsaml.extractor(idpxml, [{ localName: 'SingleLogoutService', attributes: ['index'] }])['singlelogoutservice'];
    ...
    ava_1.default('#86 duplicate issuer throws error', function (t) {
        ...
        var issuer = libsaml.extractor(xml.toString(), ['Issuer']).issuer;
